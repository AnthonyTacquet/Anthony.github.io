...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('anthony.tacquet@gmail.com', 'anthony1234tacquet')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            live = "In your hands sir!"
            print(live)
            speak(live)
    
        elif "fire" in query or "fire protocol" in query or "initiate fire protocol" in query or "start fire protocol" in query:
            fire = "Yes sir, I am initiating fire protocol, Everybody, step aside!"
            print(fire)
            speak(fire)
